...
## [10.2.0]
### Added
- [#11552](https://github.com/MetaMask/metamask-extension/pull/11552): Integrating new TokenRatesController to expand fiat conversion rates for some non-Mainnet networks
...
- [#11845](https://github.com/MetaMask/metamask-extension/pull/11845): Add support for Swaps via a direct contract for wrapping and unwrapping
- [#12042](https://github.com/MetaMask/metamask-extension/pull/12042): Add Max Fee Per Gas to transaction breakdown
- [#11999](https://github.com/MetaMask/metamask-extension/pull/11999): Add eth_feeHistory to safe method list
...
- [#11772](https://github.com/MetaMask/metamask-extension/pull/11772): Add tooltip for negative gas timing
- [#11794](https://github.com/MetaMask/metamask-extension/pull/11794): Add support for EIP-1559 to the transaction activity log

### Changed
- [#12019](https://github.com/MetaMask/metamask-extension/pull/12019): Show local nicknames on confirmation screen when invoking a contract method
...
- [#11982](https://github.com/MetaMask/metamask-extension/pull/11982): Sort contacts alphabetically
...
- [#11859](https://github.com/MetaMask/metamask-extension/pull/11859): Allow advanced inline gas editing when there is an estimates unavailable error
- [#11795](https://github.com/MetaMask/metamask-extension/pull/11795): Autofocus the unit field in send screen
- [#11775](https://github.com/MetaMask/metamask-extension/pull/11775): Ensure that gas fee inputs fallback to tx params values if gas api is down
- [#11744](https://github.com/MetaMask/metamask-extension/pull/11744): Remove estimate detail above advanced gas controls in non EIP-1559 networks
- [#11889](https://github.com/MetaMask/metamask-extension/pull/11889): Update gas controls copy
- [#11743](https://github.com/MetaMask/metamask-extension/pull/11743): Show minimum native currency in banner when on testnets
...
### Fixed
- [#12140](https://github.com/MetaMask/metamask-extension/pull/12140): Fixed `BigNumber` error in the max priority fee field
...
- [#12056](https://github.com/MetaMask/metamask-extension/pull/12056): Fixed duplicate cancel buttons on send screen when in editing stage
...
- [#12122](https://github.com/MetaMask/metamask-extension/pull/12122): Fixed issue with stuck speedup transactions
...
- [#11787](https://github.com/MetaMask/metamask-extension/pull/11787): Fixed advanced gas form display issue when there are errors
